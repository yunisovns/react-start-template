...
// import { useGetOperationQuery } from '../../services/registrationApi';

// const OperationList: React.FC = () => {
//   const [{ isLoading }] = useGetOperationQuery({});

//   // useSelector((state: RootState) => state.financialOperations.operations);
